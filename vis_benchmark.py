...
parser.add_argument('--input_path',
                    default='/data/liqiang/datasets/PU1K/test/input_512/input_512/',
                    type=str,
                    help='path to the input')
parser.add_argument('--gt_path',
                    default='/data/liqiang/datasets/PU1K/test/input_512/gt_2048/',
                    type=str,
                    help='path to the gt')
...
parser.add_argument('--png_path',
                    default='/data/liqiang/project/PU-GCN2/vis/', required=True,
                    type=str, help='name of file to show')
parser.add_argument('--filename',
                    default='02691156.37f2f187a1582704a29fef5d2b2f3d7.xyz', required=True,
                    type=str, help='name of file to show')
