...
# data
# parser.add_argument('--data_dir', default='./data/PUGAN/PUGAN_poisson_256_poisson_1024.h5')
...
parser.add_argument('--upsampler', default='nodeshuffle', type=str,
                    help="upsampler, multi_cnn, clone, duplicate, nodeshuffle, pronodeshuffle, nodeshuffle2, nodeshuffle3, pronodeshuffle2, pronodeshuffle3,ens")
