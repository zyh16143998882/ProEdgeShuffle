...
from tf_lib.gcn_lib.vertex import nodeshuffle, multi_cnn, duplicate, mlpshuffle, inception_densegcn, densegcn, gcn, \
    pronodeshuffle, nodeshuffle2, nodeshuffle3, pronodeshuffle2, ens
...
def up_unit(x,
    ...
    with tf.variable_scope(scope, reuse=tf.AUTO_REUSE):
        ...
        elif upsample.lower() == 'nodeshuffle2':
            x = nodeshuffle2(x, up_ratio,
                            k=k,
                            idx=idx,
                            scope='nodeshuffle', **kwargs)
        elif upsample.lower() == 'nodeshuffle3':
            x = nodeshuffle3(x, up_ratio,
                            k=k,
                            idx=idx,
                            scope='nodeshuffle', **kwargs)
        elif upsample.lower() == 'pronodeshuffle':
            x = pronodeshuffle(x, up_ratio,
                            k=k,
                            idx=idx,
                            scope='nodeshuffle', **kwargs)
        elif upsample.lower() == 'pronodeshuffle2':
            x = pronodeshuffle2(x, up_ratio,
                            k=k,
                            idx=idx,
                            scope='nodeshuffle', **kwargs)
        elif upsample.lower() == 'pronodeshuffle3':
            x = pronodeshuffle2(x, up_ratio,
                            k=k,
                            idx=idx,
                            scope='nodeshuffle', **kwargs)
